...
Public NotInheritable Class AuditSettingsModule
    Inherits ModuleBase
    Public Sub New()
        InitializeComponent()
    ...
    Public Sub SetupAuditTrail()
        Dim iobObjectSpace As IObjectSpace = Application.CreateObjectSpace
        Dim xpoAuditSettings As AuditSettings = AuditSettings.GetInstance(CType(iobObjectSpace, Xpo.XPObjectSpace).Session)
