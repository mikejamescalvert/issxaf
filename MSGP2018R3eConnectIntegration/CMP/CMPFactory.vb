...
#End Region
        ...
        Public Function CreateInternetAddress(ByVal InternetAddress As CMPInternetAddress) As Boolean
            ...
            If InternetAddress Is Nothing Then Return False

            Dim BT As New eConnect.Serialization.CMPInternetAddressType
            Dim taINTERNETADDRESS As New eConnect.Serialization.taCreateInternetAddresses_ItemsTaCreateInternetAddresses
            Try
                ...
                ReDim BT.taCreateInternetAddresses_Items(0)
                BT.taCreateInternetAddresses_Items(0) = taINTERNETADDRESS
