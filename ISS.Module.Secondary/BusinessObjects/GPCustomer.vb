...
Public Class GPCustomer ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    Property CustomerNumber As String
        ...
        Set(ByVal Value As String)
            SetPropertyValue(Nameof(CustomerNumber), _mCustomerNumber, Value)
        End Set
    End Property
