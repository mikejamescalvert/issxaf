            ...
            Try
                ...
                If taPMTrx.CREATEDIST = 0 Then
                    ...
                    For intLoop As Integer = 0 To PMTrx.PMTrxDistributionLines.Count - 1
                        ...
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Avail
                        '        '?
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Cash
                        '        taPMTrx.CASHAMNT = PMTrxDistributionLine.CreditAmount + PMTrxDistributionLine.DebitAmount
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Fnchg
                        '        '?
                        ...
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Gst
                        '        '?
                        ...
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Other
                        '        '?
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Pay
                        '        '?
                        ...
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Round
                        '        '?
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Taken
                        '        '?
                        ...
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Unit
                        '        '?
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Wh
                        '        '?
                        '    Case MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Write
                        '        '?
                        'End Select
                        'If PMTrxDistributionLine.DistributionType = MSGP2016eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Avail Then
