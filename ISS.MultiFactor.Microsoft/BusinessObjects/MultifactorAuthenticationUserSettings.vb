...
Public Class MultifactorAuthenticationUserSettings ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    Property SecretKey As String
        ...
        End Get
        Set(ByVal Value As String)
            SetPropertyValue(NameOf(SecretKey), _mSecretKey, Value)
        End Set
    End Property
