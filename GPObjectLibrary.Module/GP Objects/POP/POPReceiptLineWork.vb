...
Namespace Objects.POP
    ...
    ''' </summary>
    ''' <remarks></remarks>
    <Persistent("POP10310")> _
    <System.ComponentModel.DefaultProperty("Oid.POPRCTNM")> _
    <OptimisticLocking(False)> _
Public Class POPReceiptLineWork
        Inherits XPLiteObject

        Public Structure POPReceiptLineKey
        ...
        Private _mOid As POPReceiptLineKey
        <Key()>
        <Persistent()>
        Public Property Oid As POPReceiptLineKey
            Get
                Return _mOid
            End Get
            Set(ByVal Value As POPReceiptLineKey)
                _mOid = Value
            End Set
        End Property
        ...
        Public Property PURPVIDX() As Integer
            ...
            End Set
        End Property
        Dim fRemaining_AP_Amount As Decimal
        Public Property Remaining_AP_Amount() As Decimal
            Get
                Return fRemaining_AP_Amount
            End Get
            Set(ByVal value As Decimal)
                SetPropertyValue(Of Decimal)("Remaining_AP_Amount", fRemaining_AP_Amount, value)
            End Set
        End Property
