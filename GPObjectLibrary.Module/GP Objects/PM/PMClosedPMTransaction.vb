...
Namespace Objects.PM
    ...
    <Persistent("PM30200")> _
    Public Class PMClosedPMTransaction
        Inherits XPLiteObject

        Public Structure PostedCheckKey
        ...
        Dim fOid As PostedCheckKey
        <Key(True)> _
        <Persistent()> _
        Public Property Oid() As PostedCheckKey
            Get
                Return fOid
            End Get
            Set(ByVal value As PostedCheckKey)
                SetPropertyValue(Of PostedCheckKey)("Oid", fOid, value)
            End Set
        End Property
        ...
        <Action(PredefinedCategory.RecordsNavigation)> _
        Public Sub GetAvailableChecks()
            Helpers.CheckHelper.GetClosedChecks(Session)
        End Sub

        Private _mAppliedTransactionLines As XPCollection(Of PMClosedPMTransactionLine)
        Public ReadOnly Property AppliedTransactionLines() As XPCollection(Of PMClosedPMTransactionLine)
            Get
        ...
        Private Sub RefreshAppliedTransactionLines()
            ...
            If _mAppliedTransactionLines Is Nothing Then
                ...
                ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("Oid.VCHRNMBR", Me.Oid.VCHRNMBR.Trim + "%", DevExpress.Data.Filtering.BinaryOperatorType.Like))
                ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("Oid.DOCTYPE", Me.Oid.DOCTYPE, DevExpress.Data.Filtering.BinaryOperatorType.Equal))
                _mAppliedTransactionLines = New XPCollection(Of PMClosedPMTransactionLine)(Session, ddfFilter)
            End If
        End Sub

        <PersistentAlias("[<PMClosedPMTransactionLine>][Oid.VCHRNMBR = ^.Oid.VCHRNMBR AND Oid.DOCTYPE = ^.Oid.DOCTYPE].Sum(APPLDAMT)")>
        ...
        '        For Each oAppliedTransactionLine As PMClosedPMTransactionLine In AppliedTransactionLines
        ...
        Private _mDistributionLines As XPCollection(Of PMClosedPMTransactionDistribution)
        Public ReadOnly Property DistributionLines() As XPCollection(Of PMClosedPMTransactionDistribution)
            Get
        ...
        Private Sub RefreshDistributionLines()
            ...
            If _mDistributionLines Is Nothing Then
                ...
                ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("Oid.VCHRNMBR", Me.Oid.VCHRNMBR.Trim + "%", DevExpress.Data.Filtering.BinaryOperatorType.Like))
                ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("Oid.DOCTYPE", Me.Oid.DOCTYPE, DevExpress.Data.Filtering.BinaryOperatorType.Equal))
                _mDistributionLines = New XPCollection(Of PMClosedPMTransactionDistribution)(Session, ddfFilter)
            End If
        End Sub
        ...
        'Public ReadOnly Property NoteIndexO() As SY.SYNoteIndex
        '    Get
