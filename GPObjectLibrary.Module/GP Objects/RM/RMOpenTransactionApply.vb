...
Namespace Objects.RM
    ...
    ''' </summary>
    <Persistent("RM20201")>
    Public Class RMOpenTransactionApply
        Inherits XPLiteObject

        Public Structure RMOpenTransactionApply
        ...
        Dim fOid As RMOpenTransactionApply
        <Key()>
        <Persistent()>
        Public Property Oid() As RMOpenTransactionApply
            Get
                Return fOid
            End Get
            Set(ByVal value As RMOpenTransactionApply)
                SetPropertyValue(Of RMOpenTransactionApply)("Oid", fOid, value)
            End Set
        End Property
