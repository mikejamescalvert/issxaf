...
Namespace Objects.SOP
    ...
    ''' </summary>
    <Persistent("SOP30200")>
    Public Class SOPHistoricalSalesOrderHeader
        Inherits XPLiteObject

        Public Structure HistoricalSalesOrderHeaderKey
        ...
        Private _mLineItems As XPCollection(Of SOPHistoricalSalesOrderLineItem)

        Public ReadOnly Property LineItems() As XPCollection(Of SOPHistoricalSalesOrderLineItem)
            Get
                If _mLineItems Is Nothing Then
                    ...
                    _mLineItems = New XPCollection(Of SOPHistoricalSalesOrderLineItem)(Me.Session, GC)
                End If
                Return _mLineItems
            End Get
        End Property

        Dim fOid As HistoricalSalesOrderHeaderKey
        <Key()>
        <Persistent()>
        Public Property Oid() As HistoricalSalesOrderHeaderKey
            Get
                Return fOid
            End Get
            Set(ByVal value As HistoricalSalesOrderHeaderKey)
                SetPropertyValue(Of HistoricalSalesOrderHeaderKey)("Oid", fOid, value)
            End Set
        End Property
        ...
        Public ReadOnly Property BillToAddress As RM.RMCustomerAddress
            Get
                Return EvaluateAlias("BillToAddress")
            End Get
        End Property
        ...
        <PersistentAlias("[<RMReceivableDocument>][CURTRXAM > 0 And Oid.DOCNUMBR = ^.Oid.SOPNUMBE].Count()")>
        Public ReadOnly Property UnpaidDocuments As Integer
            Get
                Return EvaluateAlias("UnpaidDocuments")
            End Get
        End Property
