...
Public Class ViewCustomizationRuleAction ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    Property ActionId As String
        ...
        Set(ByVal Value As String)
            SetPropertyValue(Nameof(ActionId), _mActionId, Value)
        End Set
    End Property
