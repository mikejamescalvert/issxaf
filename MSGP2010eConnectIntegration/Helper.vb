...
Public Class Helper
    ...
    Public Shared Sub ValidateGPObject(ByVal ObjectSpace As DevExpress.ExpressApp.IObjectSpace, ByVal Target As Object)
        If Target Is Nothing Then Return
        Dim asdf As New Microsoft.Dynamics.GP.eConnect.eConnectMethods
        Dim result As RuleSetValidationResult = Validator.RuleSet.ValidateTarget(ObjectSpace, Target, New ContextIdentifiers({"GPValidation"}))
        If result.ValidationOutcome <> ValidationOutcome.Valid Then
            Throw New MSGPRequiredFieldValidationException(result.GetFormattedErrorMessage)
        End If
    End Sub
End Class
