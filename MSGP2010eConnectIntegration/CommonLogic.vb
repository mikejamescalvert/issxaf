...
Public Class CommonLogic
    ...
    Public Shared Function GetNextRMCashReceiptDocNumber(ByVal MSGPConnectionString As String) As String
        Dim NextDocNumber As New Microsoft.Dynamics.GP.eConnect.GetNextDocNumbers
        Dim ReturnDocNo As String = String.Empty
    ...
    Public Shared Function eConnectCreate(ByVal MSGPConnectionString As String, ByVal eConnectSerializationObject As Object) As Boolean
        ...
        Try
            ...
            Select Case eConnectSerializationObject.GetType.FullName
                ...
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.IVCreatePriceLevelType"
                    ReDim eConnect.IVCreatePriceLevelType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.IVCreatePriceLevelType(0) = eConnectSerializationObject

                Case "Microsoft.Dynamics.GP.eConnect.Serialization.IVCreateItemPriceListType"
                    ReDim eConnect.IVCreateItemPriceListType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.IVCreateItemPriceListType(0) = eConnectSerializationObject
                ...
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.SOPDeleteLineType"
                    ReDim eConnect.SOPDeleteLineType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.SOPDeleteLineType(0) = eConnectSerializationObject

                Case "Microsoft.Dynamics.GP.eConnect.Serialization.SOPDeleteDocumentType"
                    ReDim eConnect.SOPDeleteDocumentType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.SOPDeleteDocumentType(0) = eConnectSerializationObject

                Case Else
                    Throw New Exception("Object type not defined in eConnect Integration Library")
            End Select
            ...
            'blneConnectResult = eConCall.eConnect_EntryPoint(MSGPConnectionString, Microsoft.Dynamics.GP.eConnect.EnumTypes.ConnectionStringType.SqlClient, strXmlAsString, Microsoft.Dynamics.GP.eConnect.EnumTypes.SchemaValidationType.None, "")
            ' Return blneConnectResult

            'TODO: Need to implement this code for ecconect calls
    ...
    ' TODO: REVIEW KSC 10/20/2020 - Update Transaction Entity not using the SSPI Connection String; not used in GP2010 - Should this be added?
    ''' <summary>
