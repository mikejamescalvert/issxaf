...
Namespace SOP
    Public Class SOPOrder
        ...
        Private _mFacilityID As String
        ...
        Private _mCreateCommission As Boolean
        Public Property CreateCommission As Boolean
            Get
                Return _mCreateCommission
            End Get
            Set(value As Boolean)
                _mCreateCommission = value
            End Set
        End Property
    End Class
End Namespace