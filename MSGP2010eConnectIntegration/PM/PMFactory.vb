            ...
            Try
                ...
                If taPMTrx.CREATEDIST = 0 Then
                    ...
                    For intLoop As Integer = 0 To PMTrx.PMTrxDistributionLines.Count - 1
                        ...
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Avail
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Cash
                        '        taPMTrx.CASHAMNT = PMTrxDistributionLine.CreditAmount + PMTrxDistributionLine.DebitAmount
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Fnchg
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Freight
                        '        taPMTrx.FRTAMNT = PMTrxDistributionLine.CreditAmount + PMTrxDistributionLine.DebitAmount
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Gst
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Misc
                        '        taPMTrx.MSCCHAMT = PMTrxDistributionLine.CreditAmount + PMTrxDistributionLine.DebitAmount
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Other
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Pay
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Purch
                        '        taPMTrx.PRCHAMNT = PMTrxDistributionLine.CreditAmount + PMTrxDistributionLine.DebitAmount
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Round
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Taken
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Taxes
                        '        taPMTrx.TAXAMNT = PMTrxDistributionLine.CreditAmount + PMTrxDistributionLine.DebitAmount
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Trade
                        '        taPMTrx.TRDISAMT = PMTrxDistributionLine.CreditAmount + PMTrxDistributionLine.DebitAmount
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Unit
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Wh
                        '        '?
                        '    Case MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Write
                        '        '?
                        'End Select
                        'If PMTrxDistributionLine.DistributionType = MSGP2010eConnectIntegration.PM.PMTrxDistributionLine.DistributionTypes.Avail Then
