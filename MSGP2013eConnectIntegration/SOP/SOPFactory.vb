...
Namespace SOP
	Public Class SOPFactory
		...
		Public Function GetNextSopNumber(ByVal DocType As SOPDocTypes, ByVal DocIdKey As String) As String
			...
			End With
		End Function
        Public Function UpdateSOPOrderBatchId(SOPNUMBE As String, SOPTYPE As SOPTYPES, TargetBatchId As String) As Boolean
            Me._mExceptionMessages.Clear()

            Try

                Dim SOP As New Microsoft.Dynamics.GP.eConnect.Serialization.SOPTransactionType
                Dim taSopHdrIvcInsert As eConnect.Serialization.taSopHdrIvcInsert = GetSopHeaderForTransaction(SOPNUMBE, SOPTYPE)
