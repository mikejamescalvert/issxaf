...
#Region "Public Methods"
        ...
        Public Function CreateUpdateIVItem(ByVal IVItem As IVItemMaster, Optional ByVal UpdateIfExists As Boolean = True) As Boolean
            ...
            End With
            taIV.taUpdateCreateItemRcd = taIVItem
            Return CommonLogic.eConnectCreate(Me.MSGPConnectionString, taIV)

        End Function
        Public Function CreateUpdateIVItemVendor(ByVal IVItemVendor As IVItemVendor) As Boolean
            Dim taIVVendor As New IVVendorItemType
            Dim taIVVendorItem As New taCreateItemVendors_ItemsTaCreateItemVendors

            With taIVVendorItem
                .VNDITNUM = If(String.IsNullOrEmpty(IVItemVendor.VendorItemNumber), IVItemVendor.ItemNumber, IVItemVendor.VendorItemNumber)
                .ITEMNMBR = IVItemVendor.ItemNumber
                .VENDORID = IVItemVendor.VendorId
                .UpdateIfExists = If(IVItemVendor.UpdateIfExists, 1, 0)
            End With
            Dim taIVVendorItems = New taCreateItemVendors_ItemsTaCreateItemVendors() {taIVVendorItem}

            taIVVendor.taCreateItemVendors_Items = taIVVendorItems
            Return CommonLogic.eConnectCreate(Me.MSGPConnectionString, taIVVendor)
