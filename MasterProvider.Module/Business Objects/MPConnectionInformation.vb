...
<NonPersistent()> _
<ConditionalAppearance.Appearance("MPConnectionInformation.SQLConnection", Visibility:=Editors.ViewItemVisibility.Hide, TargetItems:="TrustedConnection;ServerName;DatabaseName;UserName", Criteria:="ConnectionType = 1 Or ConnectionType = 2")> _
<ConditionalAppearance.Appearance("MPConnectionInformation.SQLLoginType", Visibility:=Editors.ViewItemVisibility.Hide, TargetItems:="UserName;Password", Criteria:="TrustedConnection = True")> _
<ConditionalAppearance.Appearance("MPConnectionInformation.AccessConnection", Visibility:=Editors.ViewItemVisibility.Hide, TargetItems:="DatabaseLocation", Criteria:="ConnectionType = 0 Or ConnectionType = 2")> _
<ConditionalAppearance.Appearance("MPConnectionInformation.WebserviceConnection", Visibility:=Editors.ViewItemVisibility.Hide, TargetItems:="Password", Criteria:="ConnectionType = 2")> _
<ConditionalAppearance.Appearance("MPConnectionInformation.WebserviceConnectionURL", Visibility:=Editors.ViewItemVisibility.Hide, TargetItems:="URL", Criteria:="ConnectionType = 0 Or ConnectionType = 1")> _
Public Class MPConnectionInformation
    Inherits BaseObject
...
#Region "Behaviors"
    ...
    Protected Overrides Sub OnChanged(ByVal propertyName As String, ByVal oldValue As Object, ByVal newValue As Object)
        ...
        If propertyName = "ConnectionType" Then
        ...
        ElseIf propertyName = "TrustedConnection" Then
...
#Region "Properties"
    ...
    Public Property ConnectionStringName As String
        ...
        Set(ByVal Value As String)
            SetPropertyValue("ConnectionStringName", _mConnectionStringName, Value)
        End Set
    End Property
...
<VisibleInListView(False)> _
    Public Property Accepted As Boolean
        ...
        Set(ByVal Value As Boolean)
            SetPropertyValue("Accepted", _mAccepted, Value)
        End Set
    End Property
    ...
    Public Property RegistryPath As String
        ...
        End Get
        Set(ByVal Value As String)
            SetPropertyValue("RegistryPath", _mRegistryPath, Value)
        End Set
    End Property
    ...
    Public Property ConnectionType As ConnectionTypes
        ...
        Set(ByVal Value As ConnectionTypes)
            SetPropertyValue("ConnectionType", _mConnectionType, Value)
        End Set
    End Property
    ...
    Public Property ServerName As String
        ...
        End Get
        Set(ByVal Value As String)
            SetPropertyValue("ServerName", _mServerName, Value)
        End Set
    End Property
    ...
    Public Property DatabaseName As String
        ...
        End Get
        Set(ByVal Value As String)
            SetPropertyValue("DatabaseName", _mDatabaseName, Value)
        End Set
    End Property
    ...
    Public Property UserName As String
        ...
        End Get
        Set(ByVal Value As String)
            SetPropertyValue("UserName", _mUserName, Value)
        End Set
    End Property
    ...
    Public Property Password As String
        ...
        End Get
        Set(ByVal Value As String)
            SetPropertyValue("Password", _mPassword, Value)
        End Set
    End Property
    ...
    Public Property TrustedConnection As Boolean
        ...
        End Get
        Set(ByVal Value As Boolean)
            SetPropertyValue("TrustedConnection", _mTrustedConnection, Value)
        End Set
    End Property
    ...
    Public Property DatabaseLocation As String
        ...
        End Get
        Set(ByVal Value As String)
            SetPropertyValue("DatabaseLocation", _mDatabaseLocation, Value)
        End Set
    End Property
