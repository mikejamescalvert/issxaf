...
Namespace Objects.POP
    ...
    Public Class POPReceiptHistory
        ...
        Public Property VADCDTRO() As String
            ...
            End Set
        End Property
        Dim fREVALJRNENTRY As Integer
        Public Property REVALJRNENTRY() As Integer
            Get
                Return fREVALJRNENTRY
            End Get
            Set(ByVal value As Integer)
                SetPropertyValue(Of Integer)("REVALJRNENTRY", fREVALJRNENTRY, value)
            End Set
        End Property
        Dim fREVALTRXSOURCE As String
        <Size(13)> _
        Public Property REVALTRXSOURCE() As String
            Get
                Return fREVALTRXSOURCE
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("REVALTRXSOURCE", fREVALTRXSOURCE, value)
            End Set
        End Property
