...
Namespace Objects.PM
    ...
    <Persistent("PM10200")>
    Public Class PMWorkingPMTransactionLine
        Inherits XPLiteObject
        Dim fOid As PMWorkingPMTransactionLineKey
        <Key()>
        <Persistent()>
        Public Property Oid() As PMWorkingPMTransactionLineKey
            Get
                Return fOid
            End Get
            Set(ByVal value As PMWorkingPMTransactionLineKey)
                SetPropertyValue(Of PMWorkingPMTransactionLineKey)("Oid", fOid, value)
            End Set
        End Property

        Public Structure PMWorkingPMTransactionLineKey
        ...
        Public Property APTODCNM() As String
            ...
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("APTODCNM", fAPTODCNM, value)
            End Set
        End Property
        ...
        Public Property WROFAMNT() As Decimal
            ...
            End Set
        End Property
        Dim fORAPPAMT As Decimal
        Public Property ORAPPAMT() As Decimal
            Get
                Return fORAPPAMT
            End Get
            Set(ByVal value As Decimal)
                SetPropertyValue(Of Decimal)("ORAPPAMT", fORAPPAMT, value)
            End Set
        End Property
        ...
        Public Property APFRDCNM() As String
            ...
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("APFRDCNM", fAPFRDCNM, value)
            End Set
        End Property
        ...
        Public Property Revaluation_Status() As Short
            ...
            End Set
        End Property
        Dim fCredit1099Amount As Decimal
        Public Property Credit1099Amount() As Decimal
            Get
                Return fCredit1099Amount
            End Get
            Set(ByVal value As Decimal)
                SetPropertyValue(Of Decimal)("Credit1099Amount", fCredit1099Amount, value)
            End Set
        End Property
        Dim fDEFTEN99TYPE As Short
        Public Property DEFTEN99TYPE() As Short
            Get
                Return fDEFTEN99TYPE
            End Get
            Set(ByVal value As Short)
                SetPropertyValue(Of Short)("DEFTEN99TYPE", fDEFTEN99TYPE, value)
            End Set
        End Property
        Dim fDEFTEN99BOXNUMBER As Short
        Public Property DEFTEN99BOXNUMBER() As Short
            Get
                Return fDEFTEN99BOXNUMBER
            End Get
            Set(ByVal value As Short)
                SetPropertyValue(Of Short)("DEFTEN99BOXNUMBER", fDEFTEN99BOXNUMBER, value)
            End Set
        End Property
        ...
        ' Private _mAppliedToTransaction As PMWorkingPMTransaction
        <PersistentAlias("[<PMWorkingPMTransaction>][VCHRNMBR = ^.Oid.APTVCHNM].Single()")>
        Public ReadOnly Property AppliedToTransaction() As PMWorkingPMTransaction
            Get
                'RefreshAppliedTransactions()
                'Return _mAppliedToTransaction
                Return TryCast(EvaluateAlias("AppliedToTransaction"), PMWorkingPMTransaction)
            End Get
        End Property
        ' Private _mAppliedFromTransaction As PMWorkingPMTransaction
        <PersistentAlias("[<PMWorkingPMTransaction>][VCHRNMBR = ^.Oid.VCHRNMBR].Single()")>
        Public ReadOnly Property AppliedFromTransaction() As PMWorkingPMTransaction
            Get
                'RefreshAppliedTransactions()
                'Return _mAppliedFromTransaction
                Return TryCast(EvaluateAlias("AppliedFromTransaction"), PMWorkingPMTransaction)
            End Get
        End Property

        'Private Sub RefreshAppliedTransactions()
        '    Dim ddfFilter As DevExpress.Data.Filtering.GroupOperator
        '    If _mAppliedToTransaction Is Nothing Then
        '        ddfFilter = New DevExpress.Data.Filtering.GroupOperator
        '        ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("VCHRNMBR", Me.Oid.APTVCHNM, DevExpress.Data.Filtering.BinaryOperatorType.Equal))
        '        _mAppliedToTransaction = Session.FindObject(Of PMWorkingPMTransaction)(ddfFilter)
        '    End If
        '    If _mAppliedFromTransaction Is Nothing Then
        '        ddfFilter = New DevExpress.Data.Filtering.GroupOperator
        '        ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("VCHRNMBR", Me.Oid.VCHRNMBR, DevExpress.Data.Filtering.BinaryOperatorType.Equal))
        '        _mAppliedFromTransaction = Session.FindObject(Of PMWorkingPMTransaction)(ddfFilter)
        '    End If
        'End Sub
