...
Namespace Objects.PM
    ...
    Public Class PMClosedPMTransactionLine
        Inherits XPLiteObject

        Public Structure ClosedPMTransactionLineKey
        ...
        Dim fOid As ClosedPMTransactionLineKey
        <Key()>
        <Persistent()>
        Public Property Oid() As ClosedPMTransactionLineKey
            Get
                Return fOid
            End Get
            Set(ByVal value As ClosedPMTransactionLineKey)
                SetPropertyValue(Of ClosedPMTransactionLineKey)("Oid", fOid, value)
            End Set
        End Property
        ...
        'Private _mAppliedToTransaction As PMClosedPMTransaction
        <PersistentAlias("[<PMClosedPMTransaction>][Oid.VCHRNMBR = ^.Oid.APTVCHNM].Single()")>
        Public ReadOnly Property AppliedToTransaction() As PMClosedPMTransaction
            Get
                'RefreshAppliedTransactions()
                'Return _mAppliedToTransaction
                Return TryCast(EvaluateAlias("AppliedToTransaction"), PMClosedPMTransaction)
            End Get
        End Property
        ' Private _mAppliedFromTransaction As PMClosedPMTransaction
        <PersistentAlias("[<PMClosedPMTransaction>][Oid.VCHRNMBR = ^.Oid.VCHRNMBR].Single()")>
        Public ReadOnly Property AppliedFromTransaction() As PMClosedPMTransaction
            Get
                'RefreshAppliedTransactions()
                'Return _mAppliedFromTransaction
                Return TryCast(EvaluateAlias("AppliedFromTransaction"), PMClosedPMTransaction)
            End Get
        End Property
        ...
        '        ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("Oid.VCHRNMBR", Me.Oid.APTVCHNM, DevExpress.Data.Filtering.BinaryOperatorType.Equal))
        '        _mAppliedToTransaction = Session.FindObject(Of PMClosedPMTransaction)(ddfFilter)
        '    End If
        '    If _mAppliedFromTransaction Is Nothing Then
        '        ddfFilter = New DevExpress.Data.Filtering.GroupOperator
        '        ddfFilter.Operands.Add(New DevExpress.Data.Filtering.BinaryOperator("Oid.VCHRNMBR", Me.Oid.VCHRNMBR, DevExpress.Data.Filtering.BinaryOperatorType.Equal))
        '        _mAppliedFromTransaction = Session.FindObject(Of PMClosedPMTransaction)(ddfFilter)
        '    End If
        'End Sub
