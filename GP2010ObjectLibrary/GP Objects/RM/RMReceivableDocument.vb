...
Namespace Objects.RM
    ...
    ''' <remarks></remarks>
    <Persistent("RM20101")>
    Public Class RMReceivableDocument
        ...
        Public Structure RMReceivableDocumentKey
            ...
            Private fRMDTYPAL As Integer
            <Persistent("RMDTYPAL")>
            Public Property RMDTYPAL() As Integer
                Get
                    Return fRMDTYPAL
                End Get
        ...
        Dim fOid As RMReceivableDocumentKey
        <Key()> _
        <Persistent()>
        Public Property Oid() As RMReceivableDocumentKey
            Get
                Return fOid
            End Get
            Set(ByVal value As RMReceivableDocumentKey)
                SetPropertyValue(Of RMReceivableDocumentKey)("Oid", fOid, value)
            End Set
        End Property
        ...
        Public Property CSHRCTYP() As Short
            ...
            End Set
        End Property
        Dim fCBKIDCRD As String
        <Size(15)> _
        Public Property CBKIDCRD() As String
            Get
                Return fCBKIDCRD
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("CBKIDCRD", fCBKIDCRD, value)
            End Set
        End Property
        Dim fCBKIDCSH As String
        <Size(15)> _
        Public Property CBKIDCSH() As String
            Get
                Return fCBKIDCSH
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("CBKIDCSH", fCBKIDCSH, value)
            End Set
        End Property
        Dim fCBKIDCHK As String
        <Size(15)> _
        Public Property CBKIDCHK() As String
            Get
                Return fCBKIDCHK
            End Get
            Set(ByVal value As String)
                SetPropertyValue(Of String)("CBKIDCHK", fCBKIDCHK, value)
            End Set
        End Property
        ...
        Private _mAssociatedHistoricalInvoice As SOP.SOPHistoricalSalesOrderHeader
        <PersistentAlias("[<SOPHistoricalSalesOrderHeader>][Oid.SOPNUMBE = ^.Oid.DOCNUMBR And Oid.SOPTYPE in (3,4)].Single()")>
        Public ReadOnly Property AssociatedHistoricalInvoice As SOP.SOPHistoricalSalesOrderHeader
            Get

                If _mAssociatedHistoricalInvoice Is Nothing Then

                    _mAssociatedHistoricalInvoice = EvaluateAlias("AssociatedHistoricalInvoice")
                End If
                Return _mAssociatedHistoricalInvoice

            End Get
        End Property

        Private _mAssociatedWorkInvoice As SOP.SOPSalesOrderHeader
        <PersistentAlias("[<SOPSalesOrderHeader>][Oid.SOPNUMBE = ^.Oid.DOCNUMBR And Oid.SOPTYPE in (3,4)].Single()")>
        Public ReadOnly Property AssociatedWorkInvoice As SOP.SOPSalesOrderHeader
            Get
                If _mAssociatedWorkInvoice Is Nothing Then
                    _mAssociatedWorkInvoice = EvaluateAlias("AssociatedWorkInvoice")
                End If
                Return _mAssociatedWorkInvoice
            End Get
        End Property
