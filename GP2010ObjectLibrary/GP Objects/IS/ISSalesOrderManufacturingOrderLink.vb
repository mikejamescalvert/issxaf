...
Namespace Objects.IS
    ...
    Public Structure SalesOrderManufacturingOrderLinkKey
    ...
    ''' GP Table IS010001
    ''' </summary>
    <Persistent("IS010001")> _
    <DefaultProperty("SummaryInfo")> _
    <OptimisticLocking(False)> _
    <MasterProvider.Module.AllowDataModificationsInMasterProvider()> _
    Public Class ISSalesOrderManufacturingOrderLink
        Inherits XPLiteObject
        Dim fOid As SalesOrderManufacturingOrderLinkKey
        <Key()> _
        <Persistent()> _
        Public Property Oid() As SalesOrderManufacturingOrderLinkKey
            Get
                Return fOid
            End Get
            Set(ByVal value As SalesOrderManufacturingOrderLinkKey)
                SetPropertyValue(Of SalesOrderManufacturingOrderLinkKey)("Oid", fOid, value)
            End Set
        End Property
