...
Public Class CommonLogic
    ...
    Public Shared Function GetDocNumber(ByVal MSGPConnectionString As String, ByVal NumberType As DocNumberTypes, Optional ByVal SopDocumentType As SOP.SOPOrder.SopTypes = SOP.SOPOrder.SopTypes.Order, Optional ByVal SopDocumentTypeId As String = "") As String
        ...
        Select Case NumberType
            ...
            Case DocNumberTypes.ARInvoice
                ReturnDocNo = NextDocNumber.GetNextRMNumber(eConnect.IncrementDecrement.Increment, eConnect.RMPaymentType.RMInvoices, GetSSPIConnectionString(MSGPConnectionString))
        End Select
    ...
    End Function
    Public Shared Function GetNextRMPaymentNumber(ByVal MSGPConnectionString As String) As String
        Dim NextDocNumber As New Microsoft.Dynamics.GP.eConnect.GetNextDocNumbers
        Dim ReturnDocNo As String = String.Empty
        ReturnDocNo = NextDocNumber.GetNextRMNumber(eConnect.IncrementDecrement.Increment, eConnect.RMPaymentType.RMPayments, GetSSPIConnectionString(MSGPConnectionString))
        'kill the next doc number object due to connection problems per MSGP Support
        Return ReturnDocNo
        NextDocNumber.Dispose()
        NextDocNumber = Nothing
    ...
    Public Shared Function GetNextSOPDocNumber(ByVal MSGPConnectionString As String, ByVal SopDocumentType As Microsoft.Dynamics.GP.eConnect.SopType, Optional ByVal SopDocumentTypeId As String = "") As String
        Dim NextDocNumber As New Microsoft.Dynamics.GP.eConnect.GetNextDocNumbers
        Dim ReturnDocNo As String = String.Empty
        ReturnDocNo = NextDocNumber.GetNextSOPNumber(eConnect.IncrementDecrement.Increment, SopDocumentTypeId, SopDocumentType, GetSSPIConnectionString(MSGPConnectionString))
        'kill the next doc number object due to connection problems per MSGP Support
        ...
        NextDocNumber = Nothing
    End Function
    Public Shared Function GetNextRMDocNumber(ByVal MSGPConnectionString As String, ByVal DocumentType As Microsoft.Dynamics.GP.eConnect.RMPaymentType) As String
        Dim NextDocNumber As New Microsoft.Dynamics.GP.eConnect.GetNextDocNumbers
        Dim ReturnDocNo As String = String.Empty
        ReturnDocNo = NextDocNumber.GetNextRMNumber(eConnect.IncrementDecrement.Increment, DocumentType, GetSSPIConnectionString(MSGPConnectionString))
        'kill the next doc number object due to connection problems per MSGP Support
        Return ReturnDocNo
        NextDocNumber.Dispose()
        NextDocNumber = Nothing
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Shared Function eConnectCreate(ByVal MSGPConnectionString As String, ByVal eConnectSerializationObject As Object, Optional ByRef RequestData As String = "") As Boolean
        ...
        Try
            ...
            Select Case eConnectSerializationObject.GetType.FullName
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.UPRCreateEmployeeLocalTaxType"
                    ReDim eConnect.UPRCreateEmployeeLocalTaxType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.UPRCreateEmployeeLocalTaxType(0) = eConnectSerializationObject
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.UPRCreateEmployeeTaxType"
                    ReDim eConnect.UPRCreateEmployeeTaxType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.UPRCreateEmployeeTaxType(0) = eConnectSerializationObject
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.UPRCreateEmployeeType"
                    ReDim eConnect.UPRCreateEmployeeType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.UPRCreateEmployeeType(0) = eConnectSerializationObject
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.UPRCreateEmployeeStateTaxType"
                    ReDim eConnect.UPRCreateEmployeeStateTaxType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.UPRCreateEmployeeStateTaxType(0) = eConnectSerializationObject
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.UPRCreateEmployeeTaxType"
                    ReDim eConnect.UPRCreateEmployeeTaxType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.UPRCreateEmployeeTaxType(0) = eConnectSerializationObject
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.POPTransactionType"
                    ReDim eConnect.POPTransactionType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateEntity
                    eConnect.POPTransactionType(0) = eConnectSerializationObject
                ...
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.PMManualCheckType"
                    ReDim eConnect.PMManualCheckType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateTransaction
                    eConnect.PMManualCheckType(0) = eConnectSerializationObject
                ...
                Case "Microsoft.Dynamics.GP.eConnect.Serialization.RMTransactionType"
                    ReDim eConnect.RMTransactionType(0)
                    eConnectMethodType = eConnectMethodTypes.CreateTransaction
                    eConnect.RMTransactionType(0) = eConnectSerializationObject
