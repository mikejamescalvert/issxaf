...
Namespace SOP
    Public Class SOPOrderLine
        ...
        Public Property ItemTaxType As ItemTaxableTypes
            ...
            End Set
        End Property
        Private _mIntegrationId As Integer
        Property IntegrationId As Integer
            Get
                Return _mIntegrationId
            End Get
            Set(ByVal Value As Integer)
                _mIntegrationId = Value
            End Set
        End Property
        Private _mLineItemSequence As Integer
        Property LineItemSequence As Integer
            Get
                Return _mLineItemSequence
            End Get
            Set(ByVal Value As Integer)
                _mLineItemSequence = Value
            End Set
        End Property
