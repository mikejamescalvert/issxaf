...
Namespace PM
    ...
    Public Class PMVendor
        ...
        Private _mPrimaryAddressIdOverride As String
        Property PrimaryAddressIdOverride As String
            Get
                Return _mPrimaryAddressIdOverride
            End Get
            Set(ByVal Value As String)
                _mPrimaryAddressIdOverride = Value
            End Set
        End Property
