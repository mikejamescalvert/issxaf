...
Public Class SampleWcfData ' Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    ...
    Property Key As String
        ...
        Set(ByVal Value As String)
            SetPropertyValue(NameOf(Key), _mKey, Value)
        End Set
    End Property
